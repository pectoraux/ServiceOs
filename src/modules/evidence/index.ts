/**
 * ServiceOS module: /evidence.
 *
 * ServiceOS business evidence and outcome-verification records (architecture.md §6).
 *
 * Foundation placeholder (WORK-001): this file declares the module's public
 * interface and identity only. WORK-007 owns the module's business
