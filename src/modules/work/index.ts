/**
 * ServiceOS module: /work.
 *
 * Service Work identity, lifecycle, dependencies, attempts and outcomes (architecture.md §6).
 *
 * Foundation placeholder (WORK-001): this file declares the module's public
 * interface and identity only. WORK-003 owns the module's business
